...
class ProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val promo_codes_profile_frag = view.findViewById<CardView>(R.id.promo_codes_profile_frag)
        val my_orders_profile_frag = view.findViewById<CardView>(R.id.my_orders_profile_frag)
        ...
        my_orders_profile_frag.setOnClickListener {
            startActivity(Intent(context, MyOrdersHistory::class.java))
        }
